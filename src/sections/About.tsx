...
function About() {
  ...
  useEffect(() => {
    const checkMobile = () => {
      setIsMobile(window.innerWidth <= 768); // Check if the screen width is <= 768px for mobile
    };
  ...
  useEffect(() => {
    console.log('Element is in view: ', isInView); // Log when the element is in view
  }, [isInView]);
  ...
  const desktopText = {
    ...
    experience:
      ...
      'My projects range from simple static websites to more dynamic applications involving APIs and real-time data integration. I’ve gained practical experience by collaborating with fellow students on group projects and contributing to open-source communities. ' +
      'I am constantly improving my technical abilities, and I am eager to apply my skills to real-world problems, bringing fresh perspectives and a strong willingness to learn.',
  };
