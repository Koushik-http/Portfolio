...
function Index() {
  ...
  return (
    <div className="app">
      <Head>
        <title>Koushik&apos;s Portfolio</title>
        <meta name="description" content="Koushik's personal portfolio website" />
        <link rel="canonical" href="https://koushik.is-a.dev" />
        <meta property="og:title" content="Koushik's Portfolio" />
        <meta property="og:description" content="Koushik's personal portfolio website" />
        <meta property="og:url" content="https://koushik.is-a.dev" />
